! function(t) {
	...
	var o = function() {
		...
		var n = function(e, n) {
			var o = n || t;
			return e = /subsid=\d+/.test(e) ? e.replace(/subsid=\d+/g, "subsid=" + o) : e + "&subsid=" + o, n || t++, e
		};
	...
	t.exports = function f() {
		var t, e, n, o, r, i, a = arguments[0],
			...
			d = arguments.length,
			h = !1;
		for("boolean" == typeof a && (h = a, a = arguments[1] || {}, l = 2), (null == a || "object" != typeof a && "function" != typeof a) && (a = {}); l < d; ++l)
			if(null != (t = arguments[l]))
				for(e in t) n = p(a, e), a !== (o = p(t, e)) && (h && o && (s(o) || (r = c(o))) ? (r ? (r = !1, i = n && c(n) ? n : []) : i = n && s(n) ? n : {}, u(a, {
					name: e,
					newValue: f(h, i, o)
				})) : void 0 !== o && u(a, {
					name: e,
	...
	var o, r, i = n(0),
		...
		s = (o = document.referrer, r = location.href || document.URL, o = o.length > 512 ? o.substr(0, 512) : o, r = r.length > 1024 ? r.substr(0, 1024) : r, ["referer=" + encodeURIComponent(o), "href=" + encodeURIComponent(r)].join("&"));
	t.exports = {
		type: a,
		send: function(t, e, n) {
			try {
	...
	function() {
		...
		function str(t, e) {
			var n, o, r, i, a, c = gap,
				s = e[t];
			switch(s && "object" === (void 0 === s ? "undefined" : _typeof(s)) && "function" == typeof s.toJSON && (s = s.toJSON(t)), "function" == typeof rep && (s = rep.call(e, t, s)), void 0 === s ? "undefined" : _typeof(s)) {
				case "string":
					return quote(s);
				case "number":
				...
				case "object":
					...
					if(rep && "object" === (void 0 === rep ? "undefined" : _typeof(rep)))
						for(i = rep.length, n = 0; n < i; n += 1) "string" == typeof rep[n] && (r = str(o = rep[n], s)) && a.push(quote(o) + (gap ? ": " : ":") + r);
					else
						for(o in s) Object.prototype.hasOwnProperty.call(s, o) && (r = str(o, s)) && a.push(quote(o) + (gap ? ": " : ":") + r);
					return r = 0 === a.length ? "{}" : gap ? "{\n" + gap + a.join(",\n" + gap) + "\n" + c + "}" : "{" + a.join(",") + "}", gap = c, r
			}
		}
		"function" != typeof Date.prototype.toJSON && (Date.prototype.toJSON = function() {
			...
			function walk(t, e) {
				...
				if(r && "object" === (void 0 === r ? "undefined" : _typeof(r)))
					for(n in r) Object.prototype.hasOwnProperty.call(r, n) && ((o = walk(r, n)) !== undefined ? r[n] = o : delete r[n]);
	...
	function l(t, e) {
		...
		} else t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (s = document.createElement("link"), u = i(), s.rel = "stylesheet", u.appendChild(s), o = p(_, null, n = s), r = function() {
	...
	t.exports = function r(t, e, n, i, a, c, s) {
		...
		p.type = "text/javascript", p.async = !0, p.src = (s > 1 ? n : e) + t, p.onload = p.onreadystatechange = function(t) {
			u || (t && "load" === t.type || /^(loaded|complete)$/.test(this.readyState)) && (i() ? (u = !0, a && a()) : f())
		};
		var f = function() {
			u || (u = !0, s >= o ? c && c() : r(t, e, n, i, a, c, s + 1))
		};
		p.onerror = f, document.getElementsByTagName("head").item(0).appendChild(p)
	}
}, function(t, e, n) {
	"use strict";
	...
	window.__TencentCaptchaExists__ = !0, __webpack_require__(63), __webpack_require__(5);
	var Messenger = __webpack_require__(17),
		domReady = __webpack_require__(61),
		btoa = window.btoa || __webpack_require__(60),
		extend = Object.assign || __webpack_require__(2),
		loadScript = __webpack_require__(59),
		eventListener = __webpack_require__(16),
		Executor = __webpack_require__(58),
		isIEVar = __webpack_require__(57),
		isElement = __webpack_require__(56),
		invisibleIframe = __webpack_require__(55),
		...
		grayscaleFrameJs = "/tcaptcha-frame.fd79be5b.js",
		...
		jsLoadStatus = "none",
		capError = __webpack_require__(4),
		preVerifyData = {},
		capObj = void 0,
		initQueue = [],
		defaultOpt = {
	...
	Captcha.prototype = {
		...
		__show__: function() {
			var t = this.initOpts;
			if("undefined" == typeof window.AqSCode) return capError.send("ERROR_TYPE_FRAMEJS_CODE_ERROR", t.appid), alert("\u9875\u9762\u52a0\u8f7d\u5f02\u5e38\uff0c\u8bf7\u5237\u65b0\u9875\u9762\u91cd\u8bd5");
			this.destroy();
			var e = [];
			for(var n in e.push("aid=" + t.appid), e.push("accver=1"), e.push("showtype=" + t.type), e.push("ua=" + encodeURIComponent(btoa(navigator.userAgent))), e.push("noheader=" + ("" + t.showHeader == "false" ? "1" : "0")), e.push("fb=" + ("" + t.needFeedBack == "false" ? "0" : "1")), t.sid && e.push("sid=" + t.sid), preVerifyData) preVerifyData[n] && e.push(n + "=" + encodeURIComponent(preVerifyData[n]));
			t.uid = "" + (t.uin || ""), needGrayscaleJs && (e.push("grayscale=1"), t.grayscale = 1), isMobile ? (e.push("clientype=1"), t.clientype = 1, t.forceLang && e.push("lang=" + t.forceLang), t.params = "?" + e.join("&")) : (e.push("clientype=2"), t.clientype = 2, needGrayscaleJs && t.forceLang && e.push("lang=" + t.forceLang), t.params = "?" + e.join("&"), t.s_type_suffix = "?" + e.join("&"), t.src = capDomain + "/template/new_placeholder.html" + t.s_type_suffix, t.s_type = capDomain + "/cap_union_prehandle" + t.s_type_suffix, t.slide_src = capDomain + "/template/new_slide_placeholder.html" + t.s_type_suffix, t.fb = "" + t.needFeedBack == "false" ? "0" : "1"), (capObj = new AqSCode(t)).listen(callbackWrap(this, t.callback), callbackWrap(this, t.ready)), capObj.start(callbackWrap(t.start)), capObj.end(callbackWrap(t.end)), needGrayscaleJs ? ((t.top || t.left) && capObj.initPos({
				top: t.top || undefined,
	...
	executor.exec(function(t) {
		domReady(function() {
			...
			new Messenger("TCaptchaVerifyDetect").listen(function(t) {
				if(t && "object" === (void 0 === t ? "undefined" : _typeof(t))) switch(t.type) {
					case "preVerify":
